...
clusters <- map(filenames, sf_cluster_fun)%>%
            ...
            mutate(bioregion = case_when( #clean up the names and add the specified cluster names from the paper
                   ...
                   classification = case_when(
                            ...
                            bioregion == 'MAR' & cl == 1 ~ 'WSS/Outer BoF',
                            bioregion == 'MAR' & cl == 2 ~ 'WSS: Banks/Inner BoF',
                            bioregion == 'MAR' & cl == 3 ~ 'ESS: Banks',
                            bioregion == 'MAR' & cl == 4 ~ 'ESS',
                            bioregion == 'MAR' & cl == 5 ~ 'Laurentian Channel/Shelf Break',
                            bioregion == 'MAR' & cl == 6 ~ 'Slope',
                            ...
                            bioregion == 'NGSL' & cl == 2 ~ 'Channel Heads & Slopes',
                            bioregion == 'NGSL' & cl == 3 ~ 'Shallow Banks & Straits',
                            TRUE ~ NA_character_))
